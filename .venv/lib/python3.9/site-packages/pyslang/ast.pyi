...
class LSPUtilities:
    ...
    """
    @staticmethod
    def getBounds(lsp: ..., eval_context: ...) -> typing.Any:
        """
        ...
        """
    @staticmethod
    def stringifyLSP(expr: ..., compilation: ...) -> str:
        """
        Converts an LSP expression to a human-friendly string representation.
        """
    @staticmethod
    def visitLSPs(expr: ..., compilation: ..., callback: collections.abc.Callable, is_lvalue: bool = True) -> None:
        """
