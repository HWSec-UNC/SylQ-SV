...
def timeout_exit():
    ...
    if _engine_ref and hasattr(_engine_ref, '_last_manager'):
        ...
        logger.debug(f"  Assertions found: {n_assertions}")
...
def main():
    ...
    optparser.add_option(
        ...
        help="Set Logging level: DEBUG / INFO / WARNING / ERROR / CRITICAL. Default: NONE",
    )
    ...
    if options.log_level == "NONE":
        ...
        print("Logging disabled (level=NONE)", flush=True)
    else:
